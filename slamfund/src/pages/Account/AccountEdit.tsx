...
import { Button, Container, ContentContainer, ContentP3, ContentP4, Form, Input, InputContainer, Label, ReturnButton, ReturnContainer } from "../../components/credentials/components";
...
export default function AccountEdit() {
  const [credentials, setCredentials] = useState<IUserInfo>({
    username: "",
    firstName: "",
    lastName: "",
    birthday: "",
  ...
  const { user, loading, error, login, signUp, update, logout } = useAuth();
      ...
      {loading ? (
        ...
        <Form autoComplete="off">
          <Container>
            ...
            <ContentContainer>
              <ContentP4>Update Account</ContentP4>
              <ContentP3>Enter credentials to update account</ContentP3>
            </ContentContainer>
            <InputWrapper
              label="username"
              name="username"
