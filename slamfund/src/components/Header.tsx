    ...
    <Container>
      <Margin style={{ alignSelf: "center" }}>
        <SubContainer>
            ...
            <Logo onClick={() => history.push("/")}>
              ...
              >
                ...
                <line
                  ...
                  x2="352"
                  y2="57.5"
                  stroke="url(#paint0_linear_163:4)"
                  strokeWidth="3"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_163:4"
                    x1="177.5"
                    y1="59"
                    x2="385.657"
                    y2="59"
                  ...
                  >
                    <stop stopColor="#4CA60E" />
                    <stop offset="1" stopColor="#4CA60E" stopOpacity="0" />
                  </linearGradient>
                </defs>
              </svg>
              {/* </LogoSVGWrapper> */}
          ...
          <MenuContainer>
            {user ? <Logout onClick={() => logout()}>logout</Logout> : null}
